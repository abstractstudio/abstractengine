...
b.prototype.values=function(){return this.map_.values()};b.prototype[Symbol.iterator]=b.prototype.values;b.prototype.forEach=function(a,b){var e=this;this.map_.forEach(function(f){return a.call(b,f,f,e)})};return b},"es6-impl","es3");var engine={EventManager:{}},EventManager=function(){this.eventListeners={}};EventManager.prototype.addEventListener=function(a,b){void 0===this.eventListeners[a]&&(this.eventListeners[a]=[]);this.eventListeners[a].push(b)};
