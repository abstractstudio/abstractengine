...
e[a];if(c!==c&&f.key!==f.key||c===f.key)return{id:d,list:e,index:a,entry:f}}return{id:d,list:e,index:-1,entry:void 0}},e=function(a,b){var c=a.head_;return $jscomp.iteratorPrototype(function(){if(c){for(;c.head!=a.head_;)c=c.previous;for(;c.next!=c.head;)return c=c.next,{done:!1,value:b(c)};c=null}return{done:!0,value:void 0}})},f=function(){var a={};return a.previous=a.next=a.head=a},g=0;return c},"es6-impl","es3");$jscomp.ASSUME_NO_NATIVE_SET=!1;
...
EventManager.prototype.removeEventListener=function(a,b){this.eventListeners[a].pop(this.eventListeners[a].indexOf(b))};EventManager.prototype.fireEvent=function(a,b){var c;void 0!==(c=this.eventListeners[a])&&c.map(function(a){a(b)})};engine.Animation={};var Animation=function(){EventManager.call(this);this._interval=this._src=this.name=this.image=null;this._columns=this._rows=1;this.isPlaying=!0;this.isReverse=!1;this.loop=!0;this.frameIndex=this.frameCount=0;this.frameSpeed=40;this.startTime=0};$jscomp.inherits(Animation,EventManager);Animation.prototype.srcset=function(a){this._src=a;this.image=new Image;this.image.onload=this._onload.bind(this);this.image.onerror=this._onerror.bind(this);this.image.src=a};
...
Animation.prototype.play=function(a){var b=this;this.frameIndex=0;this.isPlaying=!0;!1!==a&&(this._interval=setInterval(function(){b._update()},this.frameSpeed))};Animation.prototype._update=function(){this.frameIndex++;this.frameIndex==this.frameCount&&(this.loop?this.frameIndex=0:this._onfinish())};Animation.prototype.frame=function(a){this.frameIndex=a%this.frameCount};Animation.prototype.update=function(){if(this.isPlaying){var a=Date.now();a-this.start>=this.frameSpeed&&(this.start=a,this._update())}};
...
this.content.name=this.name;this.content.type=this.type;for(var e in this.options)this.options.hasOwnProperty(e)&&(this.content[e]=this.options[e]);this.content.src=this.path};var AssetManager=function(){EventManager.call(this);this.assetJobs=[];this.assetMap={};this.assetStatus=CREATED};$jscomp.inherits(AssetManager,EventManager);AssetManager.prototype.queueAsset=function(a,b,c,d){this.assetJobs.push(new Asset(a,b,c,d))};
...
Engine.prototype._start=function(){var a=this;setInterval(function(){return a._update()},this.updateInterval);this._render()};Engine.prototype._update=function(){var a=Date.now()-this.updateTime;this.updateTime=Date.now();this.update(a)};
...
Engine.prototype.stop=function(){};Engine.prototype.cleanup=function(){};Engine.prototype.main=function(){this._setup()};Engine.prototype.fps=function(){return this.renderHistory.map(function(a){return 1E3/a}).reduce(function(a,b){return a+b},0)/this.renderTrackingCount};engine.Vector={};var Vector=function(a,b){this.x=a||0;this.y=b||0};Vector.prototype.add=function(a){this.x+=a.x;this.y+=a.y;return this};Vector.prototype.sub=function(a){this.x-=a.x;this.y-=a.y;return this};Vector.prototype.scale=function(a){this.x*=a;this.y*=a;return this};Vector.prototype.dot=function(a){return this.x*a.x+this.y*a.y};Vector.prototype.dotdot=function(){return this.dot(this)};Vector.prototype.magnitude=function(){return Math.sqrt(this.dotdot())};
Vector.prototype.normalize=function(){this.scale(1/this.magnitude());return this};Vector.prototype.copy=function(){return new Vector(this.x,this.y)};Vector.prototype.toString=function(){return"("+this.x+","+this.y+")"};Vector.distance=function(a,b){return Math.sqrt((b.x-a.x)*(b.x-a.x)+(b.y-a.y)*(b.y-a.y))};engine.Particle={};engine.ParticleSystem={};var Particle=function(a,b,c){this.pos=new Vector(a,b);this.angle=0;this.vel=new Vector(0,0);this.alive=!0;this.life=c||0;this.radius=0;this.color=[];this.deltaRadius=0;this.deltaColor=[]};Particle.prototype.update=function(a){this.life-=a;this.radius+=this.deltaRadius*a;for(var b=0;b<this.color.length;b++)this.color[b]+=this.deltaColor[b]*a;0>=this.life?this.alive=!1:this.pos.add(this.velocity.copy().scale(a))};
Particle.prototype.render=function(a,b){b?(a.save(),a.translate(this.pos.x,this.pos.y),a.rotate(-this.rot),a.translate(-this.pos.x,-this.pos.y),a.drawImage(b,0,0,b.width,b.height,this.pos.x-this.radius,this.pos.y-this.radius,2*this.radius,2*this.radius),a.restore()):(a.fillStyle="rgba("+Math.round(this.color[0])+", "+Math.round(this.color[1])+", "+Math.round(this.color[2])+", "+Math.round(this.color[3])+")",a.fillRect(this.pos.x-this.radius,this.pos.y-this.radius,2*this.radius,2*this.radius))};
var ParticleSystem=function(a,b){this.particlePool=[];this.emitCounter=this.emissionRate=this.particleIndex=this.particleCount=this.totalParticles=0;this.active=!1;this.duration=0;this.properties={image:null,pos:new Vector(a,b),posVar:new Vector(0,0),speed:0,speedVar:0,angle:0,angleVar:0,life:0,lifeVar:0,startRadius:0,startRadiusVar:0,endRadius:0,endRadiusVar:0,startColor:[],startColorVar:[0,0,0,0],endColor:[],endColorVar:[0,0,0,0]}};
ParticleSystem.prototype.setProperties=function(a){for(var b in a)this.properties[b]=a[b]};ParticleSystem.prototype.init=function(){this.particlePool=[];for(var a=0;a<this.totalParticles;a++)this.particlePool.push(new Particle);this.particleCount=0;this.active=!0};
ParticleSystem.prototype.resetParticle=function(){var a=this.properties.pos.x+this.properties.posVar.x*this.rand(),b=this.properties.pos.y+this.properties.posVar.y*this.rand(),a=new Particle(a,b,this.properties.life+this.properties.lifeVar*this.rand());a.angle=this.properties.angle+this.properties.angleVar*this.rand();b=this.properties.speed+this.properties.speedVar*this.rand();a.velocity=new Vector(b*Math.cos(a.angle),b*Math.sin(a.angle));a.radius=this.properties.startRadius+this.properties.startRadiusVar*
this.rand();this.properties.endRadius&&(b=this.properties.endRadius+this.properties.endRadiusVar*this.rand(),a.deltaRadius=(b-a.radius)/a.life);if(this.properties.startColor){for(var b=[],c=0;c<this.properties.startColor.length;c++)b.push(this.properties.startColor[c]+this.properties.startColorVar[c]*this.rand());for(var d=[],c=0;c<b.length;c++)d[c]=b[c];if(this.properties.endColor)for(c=0;c<this.properties.endColor.length;c++)d[c]=this.properties.endColor[c]+this.properties.endColorVar[c]*this.rand();
a.color=b;a.deltaColor=[];for(c=0;c<b.length;c++)a.deltaColor.push((d[c]-b[c])/a.life)}return a};ParticleSystem.prototype.addParticle=function(){if(this.isFull())return!1;this.particlePool[this.particleCount++]=this.resetParticle();return!0};
ParticleSystem.prototype.update=function(a){if(this.active){if(this.emissionRate){var b=1/this.emissionRate;for(this.emitCounter+=a;!this.isFull()&&this.emitCounter>b;)this.addParticle(),this.emitCounter=0}for(this.particleIndex=0;this.particleIndex<this.particleCount;)this.updateParticle(a,this.particlePool[this.particleIndex],this.particleIndex)}};
ParticleSystem.prototype.updateParticle=function(a,b,c){b.alive?(b.update(a),this.particleIndex++):(this.swapParticles(c,this.particleCount-1),this.particleCount--);return b};ParticleSystem.prototype.swapParticle=function(a,b){var c=this.particlePool[a];this.particlePool[a]=this.particlePool[b];this.particlePool[b]=c};ParticleSystem.prototype.isFull=function(){return this.particleCount===this.totalParticles};ParticleSystem.prototype.rand=function(){return 2*Math.random()-1};
ParticleSystem.prototype.render=function(a){for(var b=0;b<this.particleCount;b++){var c=this.particlePool[b];c.alive&&(this.properties.image?c.render(a,this.properties.image):c.color&&c.render(a))}};engine.Sprite={};var Sprite=function(a,b,c,d,e,f,g){this.engine=a;this.pos=new Vector(b||0,c||0);this.center=new Vector(f||d/2||0,g||e/2||0);this.rot=0;this.width=d||0;this.height=e||0;this.assets={};this.renderable=null};Sprite.prototype.addAsset=function(a){this.assets[name||a.name]=a};Sprite.prototype.hasRenderable=function(){return null!=this.renderable};Sprite.prototype.setRenderable=function(a){this.renderable=this.assets[a].isRenderable&&this.assets[a]||null};
Sprite.prototype.translate=function(a,b){this.pos.x+=a;this.pos.y+=b};Sprite.prototype.bbox=function(){};Sprite.prototype.touches=function(a){};Sprite.prototype.update=function(a){};Sprite.prototype.render=function(a){a.save();a.translate(this.pos.x,this.pos.y);a.rotate(-this.rot);a.translate(-this.pos.x,-this.pos.y);if(this.hasRenderable()){var b=this.renderable,c=this.pos;"image"==b.type?a.drawImage(b,c.x,c.y,this.width,this.height):"animation"==b.type&&a.drawAnimation(b,c.x,c.y,this.width,this.height)}a.restore()};var Demo=function(a){Engine.apply(this,arguments)};$jscomp.inherits(Demo,Engine);Demo.prototype.setup=function(){};Demo.prototype.load=function(){};Demo.prototype.update=function(a){};Demo.prototype.render=function(a){a.fillStyle="white";a.fillRect(0,0,this.canvas.width,this.canvas.height);a.fillStyle="black";a.font="20px Verdana";a.textBaseline="hanging";a.fillText(Math.round(this.fps())+"",10,10)};Demo.prototype.stop=function(){};Demo.prototype.cleanup=function(){};window.Demo=Demo;
